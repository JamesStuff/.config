...
keymap.set("n", "<leader>fs", function() Snacks.picker.grep() end, { desc = "Live grep in cwd" })
keymap.set("n", "<leader>fc", function() Snacks.picker.grep_word() end, { desc = "Grep string under cursor" })

-- TODOs (assuming you're using todo-comments + Snacks)
keymap.set("n", "<leader>ft", function() Snacks.picker.todos() end, { desc = "Find TODOs" })
keymap.set("n", "<leader>fq", function() Snacks.picker.qflist() end, { desc = "Quickfix List" })
keymap.set("n", "<leader>fT", function() Snacks.picker() end, { desc = "Open Snacks picker menu" })
...
keymap.set("n", "<leader>fk", function() Snacks.picker.keymaps() end, { desc = "Keymaps" })
keymap.set("n", "<leader>n", function() Snacks.picker.notifications() end, { desc = "Notifications" })
...
keymap.set("n", "<leader>fS", function() Snacks.picker.lsp_workspace_symbols() end, { desc = "LSP Workspace Symbols" })
